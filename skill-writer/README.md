...
Creates new Hermes Agent skills from a description. Given a topic and concept, generates a complete, sanitized skill package ready for the Hermes-Skills repo.
...
```bash
cp skill-writer/SKILL.md ~/.hermes/skills/devops/skill-writer/SKILL.md
```
...
| `SKILL_AUTHOR_NAME` | No | `João Silva` | Name for attribution |
